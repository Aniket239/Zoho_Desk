      ...
      if request_data.dig('_json', 0, 'eventType') == 'Ticket_Update'
        ...
        if recipient_email
          ...
          unless customer_care_emails.include?(normalized_email)
            ...
            button_regex = /<a href="https:\/\/c2c0-49-37-8-195.ngrok-free.app\/tickets\/issue[^"]*"[^>]*>\s*Issue Solved\s*<\/a>/
